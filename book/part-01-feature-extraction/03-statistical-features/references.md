...
- `pandas` 窗口函数：https://pandas.pydata.org/docs/user_guide/window.html
- `statsmodels` 时间序列工具：https://www.statsmodels.org/stable/tsa.html
- tsfresh 文档（系统化的时序特征工程）：https://tsfresh.readthedocs.io/
