"""Generate book/appendix/A-papers/index.html and book/appendix/B-patents/index.html.

Reads CSV indexes and per-item README.html docs under the book/appendix tree.
Reuses CSS/JS skeleton from book/appendix/A-papers/alibaba/index.html.
Does NOT read PDFs.

Usage:
    python3 tools/build_index.py            # generate both papers and pdfs
    python3 tools/build_index.py papers     # papers only
    python3 tools/build_index.py pdfs       # pdfs only
"""
import csv
import re
import sys
...
ALIBABA_INDEX = REPO_ROOT / "book" / "appendix" / "A-papers" / "alibaba" / "index.html"
PAPERS_DIR = REPO_ROOT / "book" / "appendix" / "A-papers" / "netman"
PDFS_DIR = REPO_ROOT / "book" / "appendix" / "B-patents"
...
def load_papers_csv():
    """Return list of dicts from book/appendix/A-papers/netman/papers_index.csv."""
    with (PAPERS_DIR / "papers_index.csv").open(encoding="utf-8") as f:
        return list(csv.DictReader(f))


def load_patents_csv():
    """Return list of dicts from book/appendix/B-patents/patents_index.csv."""
...
<p class="top-links">
  ...
  <a href="../../B-patents/index.html">对比必示专利 30 件</a>
</p>
...
<p class="top-links">
  <a href="../../../README.md">⬅ 返回根 README</a>
  <a href="../A-papers/alibaba/index.html">对比阿里 AIOps 16 篇</a>
  <a href="../A-papers/netman/index.html">对比清华 NetMan 176 篇</a>
</p>
